...
def create_models(backbone_retinanet, num_classes, weights, multi_gpu=0,
                  freeze_backbone=False, learning_rate=1e-5, config=None):
    ...
    # Optionally wrap in a multi-GPU strategy.
    if multi_gpu > 1:
    ...
    training_model.compile(
        ...
        optimizer=keras.optimizers.Adam(learning_rate=learning_rate, clipnorm=0.001)
    )
